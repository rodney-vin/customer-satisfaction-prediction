...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(179); /* eslint-env es6 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "_/_/node_modules/bootstrap/dist/fonts/glyphicons-halflings-regular.eot";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "_/_/node_modules/bootstrap/dist/fonts/glyphicons-halflings-regular.svg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dropzone = __webpack_require__(178);
	...
	var Loader = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'svg',
	      { viewBox: '25 25 50 50', className: 'loader loader--dark' },
	      React.createElement('circle', { r: '20', cy: '50', cx: '50', className: 'loader__path' })
	    );
	  }
	});
	
	var LoaderImpl = React.createClass({
	  displayName: 'LoaderImpl',
	...
	var ModelContainer = React.createClass({
	  ...
	  _onStreamSelectChange: function _onStreamSelectChange(event) {
	  ...
	  _onTableSelectChange: function _onTableSelectChange(event) {
	  ...
	  render: function render() {
	    ...
	    if (this.state.selectedStreamData != null && Object.keys(this.state.selectedStreamData.tableData).length > 1) {
	      (function () {
	        ...
	        tableSelect = React.createElement(
	          'select',
	          { id: 'tableSelect', onChange: _this._onTableSelectChange, className: 'form-control model-select' },
	          React.createElement(
	            'option',
	            { disabled: true, selected: true, key: 'select a branch' },
	            ' -- select a branch -- '
	          ),
	          Object.keys(_this.state.selectedStreamData.tableData).map(function (tableName) {
	            return React.createElement(
	              'option',
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'select',
	        { id: 'streamSelect', onChange: this._onStreamSelectChange, className: 'form-control model-select' },
	        React.createElement(
	          'option',
	          { disabled: true, selected: true, key: 'select a model' },
	          ' -- select a model -- '
	        ),
	        data.map(function (entry) {
	          return React.createElement(
	            'option',
	            { value: JSON.stringify(entry), key: entry.id },
	            entry.stream
	          );
	        })
	      ),
	...
	var ExpandingText = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'p',
	        { style: msgStyle, onClick: this._expand },
	        this.props.val
	      ),
	      React.createElement(
	        'div',
	...
	var Input = React.createClass({
	  ...
	  _onDrop: function _onDrop(files) {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('textarea', {
	          style: textareaStyle,
	          required: true, className: 'form-control ioTextStyle', rows: '6', value: this.state.inputText,
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'table',
	          { id: 'scoreTable', className: 'table table-bordered light-color2' },
	          React.createElement(
	            'thead',
	            null,
	            React.createElement(
	...
	var RunButton = React.createClass({
	  ...
	  _updateResponse: function _updateResponse(e) {
	    alert.clear();
	    e.preventDefault();
	...
	var AlertImpl = React.createClass({
	  ...
	  render: function render() {
	    if (!this.state.display) return null;else return React.createElement(
	      'div',
	...
	var mainLoader = ReactDOM.render(React.createElement(LoaderImpl, null), document.getElementById('loader'));
	ReactDOM.render(React.createElement(RunButton, null), document.getElementById('runButton'));
	
	var modelComponent = ReactDOM.render(React.createElement(ModelContainer, null), document.getElementById('modelCntn'));
	var inputComponent = ReactDOM.render(React.createElement(Input, null), document.getElementById('inputCntn'));
	var alert = ReactDOM.render(React.createElement(AlertImpl, null), document.getElementById('alert'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./images/bluemix_icon.png": 180,
		"./images/model_selection.png": 181,
		"./images/pa_icon.png": 182,
		"./images/scoring_result.png": 183,
		"./images/upload.svg": 184,
		"./index.html": 185,
		"./overview.html": 186
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "images/bluemix_icon.png";
